...
def plot_roc(y_pred, y_true, roc_name, plot=False):
    ...
    if plot: 
        ...
        plt.savefig("./result/ROC CURVE.jpg")
        plt.close()
...
def plot_pr(y_pred, y_true, pr_name, plot=False):
    ...
    if plot: 
        ...
        # show the plot
        plt.savefig("./result/PRECISION-RECALL CURVE.jpg")
        plt.close()
    return precision, recall, thresholds

def evaluate(y_pred, y_true, cxr_label, 
    ...
    fpr, tpr, thresholds, roc_auc = plot_roc(y_pred, y_true, roc_name, plot=False)
    ...
    precision, recall, thresholds = plot_pr(y_pred, y_true, pr_name, plot=False)
